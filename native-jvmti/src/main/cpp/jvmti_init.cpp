...
//jin方法映射表
static const char *className = "com.example.native_jvmti/MTJvmTi";
static JNINativeMethod native_methods[] = {
        {"registerCommunityHandler", "(Lcom/example/native_jvmti/NativeCommunityHandler;)V", (void *) register_community_handler}
};
